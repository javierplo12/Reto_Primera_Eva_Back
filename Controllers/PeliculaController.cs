...
namespace Reto_Primera_Eva.Controllers
{
    ...
    public class PeliculaController : ControllerBase
    {
        ...
        public static void InicializarDatos()
        {
            ...
            peliculas.Add(new Pelicula(7, "Robot Salvaje", "Chris Sanders", "La película sigue el épico viaje de un robot -la unidad 7134 de Roz, que naufraga en una isla deshabitada y debe aprender a adaptarse al duro entorno, entablando gradualmente relaciones con los animales de la isla y convirtiéndose en padre adoptivo de un gosling huérfano.", 101, new DateTime(2024, 10, 11), "Aventura", "https://i.pinimg.com/736x/4e/00/c0/4e00c054f43b9ebf5d2cec4082cd9380.jpg"));
            ...
            peliculas.Add(new Pelicula(9, "Terrifier 3", "Damien Leone", "Un hacker descubre que el mundo es una simulación.", 125, new DateTime(2024, 10, 31), "Terror", "https://i.pinimg.com/736x/20/7d/b1/207db1d2e7463baba70d45dc8e0a80a6.jpg"));
        }
    }
}
