...
namespace Reto_Primera_Eva.Controllers
{
    ...
    public class PeliculaController : ControllerBase
    {
        ...
        public static void InicializarDatos()
        {
            ...
            peliculas.Add(new Pelicula(9, "Terrifier 3", "Damien Leone", "Un hacker descubre que el mundo es una simulación.", 125, new DateTime(2024, 10, 31), "Terror"));
        }
    }
}
